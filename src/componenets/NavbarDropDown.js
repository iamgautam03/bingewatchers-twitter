...
export default function NavbarDropDown(props) {
    return (
        <div className="d-flex main-dropdown">
            <button className="btn border rounded-1 border-dark main-dropdown dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul className="dropdown-menu" style={{backgroundColor: 'var(--header-white)'}} aria-labelledby="navbarDropdown">
