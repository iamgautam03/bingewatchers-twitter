                ...
                <div className="modal-body">
                    <form id='signupForm'>
                        <div className="mb-3">
                            ...
                            <input type="text" name='name' onChange={handleOnChage} className="form-control" id="signupName" />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="signupEmail" className="form-label">Email</label>
                            <input type="email" name='email' onChange={handleOnChage} className="form-control" id="signupEmail" />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="signupPassword" className="form-label">Password</label>
                            <input type="password" name='password' onChange={handleOnChage} className="form-control" id="signupPassword" />
                        </div>
                    </form>
                </div>
                <div className="modal-footer">
                    <button type="button" className="btn modal-auth-btn" form='signupFrom' onClick={singupVerifier}>SignUp</button>
