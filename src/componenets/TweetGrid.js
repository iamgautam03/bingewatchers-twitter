...
export default function TweetGrid () {
    const tweets = [
        ...
        },
        {
            ...
            tweet: 'Have all of you watched the anime attack on titan, it is so good as the last part has been started the popular platform crunchyroll got crashed on first episode due to heavt load!'
        },
        {
            name: 'Alvin James',
        ...
        },
        {
            ...
            tweet: 'Though last season of money hiest was so hyped the ending was not so good which lead the series to not meet up to the mark of fans.'
        }
    ];
    return (
